...
import subduapartdua.dicoding.farid.footballschedulepart2.R.id.rv_next_match
...
import subduapartdua.dicoding.farid.footballschedulepart2.content.presenter.NextMatchPresenter
...
class NextMatchActivity : AppCompatActivity() , MatchView.View{
    lateinit var presenterMatch : NextMatchPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenterMatch = NextMatchPresenter(this, requestAPI, scheduler)
    ...
    override fun displayMatchFootball(matchList: List<EventResponse>) {
        ...
        rv_next_match.adapter = MatchAdapter(matchList,applicationContext)
    }
}
