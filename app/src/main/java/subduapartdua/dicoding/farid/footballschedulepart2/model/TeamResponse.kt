...
data class TeamResponse(
        ...
        @SerializedName("strDescriptionCN") var strDescriptionCN: Any,
        @SerializedName("strDescriptionDE") var strDescriptionDE: String,
        @SerializedName("strDescriptionEN") var strDescriptionEN: String,
        @SerializedName("strDescriptionES") var strDescriptionES: Any,
        @SerializedName("strDescriptionFR") var strDescriptionFR: Any,
        @SerializedName("strDescriptionHU") var strDescriptionHU: Any,
        @SerializedName("strDescriptionIL") var strDescriptionIL: Any,
        @SerializedName("strDescriptionIT") var strDescriptionIT: String,
        @SerializedName("strDescriptionJP") var strDescriptionJP: Any,
        @SerializedName("strDescriptionNL") var strDescriptionNL: Any,
        @SerializedName("strDescriptionNO") var strDescriptionNO: Any,
        @SerializedName("strDescriptionPL") var strDescriptionPL: Any,
        @SerializedName("strDescriptionPT") var strDescriptionPT: Any,
        @SerializedName("strDescriptionRU") var strDescriptionRU: Any,
        @SerializedName("strDescriptionSE") var strDescriptionSE: Any,
        @SerializedName("strDivision") var strDivision: Any,
